...
class HistoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: const GlobalAppBar(title: "Buyurtmalar tarixi",
        appbarColor: AppColors.c_870B9B,
        titleColor: Colors.white,),
      body: Padding(padding: EdgeInsets.only(left: 11,right: 11,top: 5),
      child: ListView.builder(
          ...
          itemBuilder: (c, i) => OrderItem(
              ...
              price: "15000",
              statusColor:i.isOdd? AppColors.c_F9A825:AppColors.c_F2271C,
